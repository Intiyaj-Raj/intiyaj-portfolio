...
const frontendSkills = ["React.js", "JavaScript", "HTML5", "CSS3", "Tailwind CSS", "Bootstrap", "Responsive Design"];
// Backend Development
const backendSkills = ["Node.js", "Express.js", "REST APIs", "JWT Auth", "API Integration", "Server-Side Logic"];
// Database & Programming Languages
const mobileSkills = ["MongoDB", "Database Design", "JavaScript (ES6+)", "Mongoose", "Data Modeling"];
// Tools & Platforms / Web Development Concepts
const toolsSkills = ["Git", "GitHub", "WordPress", "VS Code", "Postman", "npm", "Responsive Web Design"];

const aboutWords = [
  { text: "Hey," }, { text: "I'm" },
  { text: "Intiyaj Ansari.", className: "font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400" },
  { text: "A" }, { text: "MERN" }, { text: "Stack" }, { text: "Developer" }, { text: "and" }, { text: "WordPress" }, { text: "Developer" }, { text: "specializing" }, { text: "in" }, { text: "building" }, { text: "modern," }, { text: "responsive" }, { text: "web" }, { text: "applications" }, { text: "using" },
  ...
  { text: "and" },
  { text: "WordPress.", className: "text-white font-medium" },
  { text: "I" }, { text: "focus" }, { text: "on" }, { text: "delivering" }, { text: "clean" }, { text: "code," }, { text: "REST" }, { text: "API" }, { text: "driven" }, { text: "architecture," }, { text: "and" }, { text: "production-ready" }, { text: "full-stack" }, { text: "web" }, { text: "experiences." }
];
...
const About = () => {
  ...
  return (
    <section id="about" className="min-h-screen bg-[#050505] text-white pt-24 pb-0 px-6 md:px-16 flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 lg:gap-24 items-center">
          ...
          <div ref={imageRef} className="flex justify-center lg:justify-start pl-0 lg:pl-16">
            <img
              src={aboutImage}
              alt="Intiyaj Ansari - MERN Stack Developer & WordPress Developer"
      ...
      {/* Answer Engine Optimization: hidden Q&A content, no visual/layout impact */}
      <div className="sr-only" aria-hidden="false">
        <h3>Who is Intiyaj Ansari?</h3>
        <p>Intiyaj Ansari is a MERN Stack Developer and WordPress Developer based in India, experienced in React.js, Node.js, Express.js, MongoDB and WordPress.</p>
        <h3>What does Intiyaj Ansari do?</h3>
        <p>Intiyaj Ansari builds modern, responsive, full-stack web applications and WordPress websites using the MERN stack.</p>
        <h3>Is Intiyaj Ansari a MERN Stack Developer?</h3>
        <p>Yes, Intiyaj Ansari is a MERN Stack Developer skilled in MongoDB, Express.js, React.js, and Node.js.</p>
        <h3>What technologies does Intiyaj Ansari use?</h3>
        <p>Intiyaj Ansari uses React.js, JavaScript, Node.js, Express.js, MongoDB, REST APIs, HTML5, CSS3, Tailwind CSS, Bootstrap, Git/GitHub, and WordPress.</p>
        <h3>Is Intiyaj Ansari a React Developer?</h3>
        <p>Yes, Intiyaj Ansari builds frontend interfaces using React.js as part of the MERN stack.</p>
      </div>
